...
*/
  ...
  _buildRatedChiefs() => BlocConsumer<CooksManagerCubit, CooksManagerState>(
        listener: (context, state) {
          ...
          child: HorizontalListView(
            ...
            itemBuilder: (index) => Padding(
              ...
              child: OpenContainer(
                ...
                openBuilder: (BuildContext context, void Function({Object? returnValue}) action) => CookProfileScreen(),
              ),
            ),
          ),
        ),
